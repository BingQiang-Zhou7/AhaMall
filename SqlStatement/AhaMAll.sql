...
INSERT INTO `commodity` VALUES ('apple_003', 'macbook_pro', '笔记本', 14165, '2017-09', 'apple/macpro.jpeg', 'Apple/苹果 \r\n13 英寸 MacBook Pro \r\nMulti-Touch Bar 和 Touch ID 3.1GHz 处理器 256GB 存储容量 深空灰色', 1, 1);
INSERT INTO `commodity` VALUES ('apple_004', 'ipad_pro', '平板', 5134, '2017-09', 'apple/ipadpro.jpg', 'Apple/苹果 10.5 英寸 iPad Pro WLAN 64GB 深空灰色', 1, 1);
INSERT INTO `commodity` VALUES ('apple_005', 'iwatch_3', '智能穿戴', 2565, '2017-09', 'apple/iwatch3.jpg', 'Apple/苹果 Watch Series 3 深空灰色铝金属表壳搭配黑色运动型表带', 1, 1);
INSERT INTO `commodity` VALUES ('apple_006', 'airpods', '配件', 1276, '2016-09', 'apple/airpods.jpg', 'Apple/苹果 AirPods', 1, 1);
INSERT INTO `commodity` VALUES ('hp_001', 'envy x360', '笔记本', 7499, '2018-01', 'hp/envy15x360.png', '惠普薄锐HP ENVY X360 15-bp105tx 笔记本电脑(英特尔8代处理器)', 0, 1);
INSERT INTO `commodity` VALUES ('hp_002', 'elitebook x360', '笔记本', 12999, '2018-03', 'hp/eliteBookx360g2.png', '惠普精英HP EliteBook x360 1030 G2 变形本（能源之星）', 0, 1);
INSERT INTO `commodity` VALUES ('hp_003', 'mouse 200', '配件', 79, '2016-09', 'hp/mouse200.png', '惠普HP 200 无线鼠标', 0, 1);
INSERT INTO `commodity` VALUES ('huawei_001', 'mate rs', '手机', 9999, '2018-04', 'huawei/maters.jpg', 'HUAWEI Mate RS 保时捷设计 6GB+256GB 全网通版（玄黑）', 1, 0);
INSERT INTO `commodity` VALUES ('huawei_002', 'honor 10', '手机', 2599, '2018-04', 'huawei/honor10.jpg', '荣耀10 AI摄影手机 6GB+64GB 幻影蓝 全网通 双卡双待 高配版', 1, 0);
INSERT INTO `commodity` VALUES ('huawei_003', 'matebook x pro', '笔记本', 12988, '2018-04', 'huawei/matebookxpro.jpg', 'HUAWEI MateBook X Pro 13.9英寸笔记本电脑 深空灰 i7 16GB 512GB 独显', 1, 0);
INSERT INTO `commodity` VALUES ('huawei_004', 'pad m5', '平板', 2888, '2018-04', 'huawei/padm5.jpg', '华为平板 M5 10.8英寸 4GB+64GB WiFi版（深空灰）', 1, 0);
INSERT INTO `commodity` VALUES ('huawei_005', 'smartwatch', '智能穿戴', 4988, '2017-11', 'huawei/smartwatch.jpg', 'PORSCHE DESIGN | HUAWEI Smartwatch 华为智能手表 保时捷联合设计（曜石黑）', 1, 0);
INSERT INTO `commodity` VALUES ('huawei_006', 'mobile charging', '配件', 99, '2016-05', 'huawei/mobilecharging.jpg', '荣耀5000mAh 移动电源（石墨黑）', 1, 0);
INSERT INTO `commodity` VALUES ('oppo_001', 'r15', '手机', 3199, '2018-05', 'oppo/r15.png', 'OPPO R15 星云特别版 全面屏AI智能拍照全网通手机 6+128GB', 1, 0);
INSERT INTO `commodity` VALUES ('oppo_002', 'charging adapter', '配件', 79, '2016-10', 'oppo/chargingadapter.png', '闪充电源适配器 VC54JBCH不带数据线', 1, 0);
INSERT INTO `commodity` VALUES ('vivo_001', 'x21 fifa', '手机', 3698, '2018-06', 'vivo/x21.png', 'X21 FIFA世界杯非凡版【FIFA世界杯官方定制典藏礼盒，预定加赠运动臂带】 礼盒含主题保护壳+vivo蓝定制足球，屏幕指纹解锁，19:9全面屏，128G大内存', 0, 0);
INSERT INTO `commodity` VALUES ('vivo_002', 'mambo hr', '智能穿戴', 199, '2014-12', 'vivo/mambohr.png', '乐心mambo HR版 乐心智能手环mambo HR 24小时连续心率监测 来电显示震动提醒 计步 专业运动手环', 1, 0);
INSERT INTO `commodity` VALUES ('vivo_003', 'xe 1000', '配件', 1999, '2017-08', 'vivo/xe1000.png', 'XE1000头戴式耳机 vivo原装Hi-Fi耳机，XE1000头戴式耳机，高保真音质，德产定制三明治振膜，多金属完美结合；数千人试戴，精巧设计，舒适佩戴体验。 ', 1, 0);
INSERT INTO `commodity` VALUES ('xiaomi_001', 'pad 3', '平板', 1499, '2017-04', 'xiaomi/pad3.jpg', '小米平板 3 6600mAh 轻薄超大电量，精彩海量内容 64GB', 0, 0);
INSERT INTO `commodity` VALUES ('xiaomi_002', 'mix 2s', '手机', 3299, '2018-05', 'xiaomi/mix2s.jpg', '小米MIX 2S 搭载高通骁龙845 年度旗舰处理器 / AI超感光双摄，DxO百分相机 / 艺术品般陶瓷机身', 0, 0);
INSERT INTO `commodity` VALUES ('xiaomi_003', 'notebook pro ', '笔记本', 5599, '2017-09', 'xiaomi/notebookpro.jpg', '小米笔记本Pro 15.6英寸 NVIDIA MX150 2G独显/全金属强化机身/FHD全贴合屏幕 /丰富接口多达7个', 1, 0);
INSERT INTO `commodity` VALUES ('xiaomi_004', 'wristband 2', '智能穿戴', 149, '2018-02', 'xiaomi/wristband2.jpg', '小米手环2 OLED显示屏，时间、步数、心率，触手可及 / 全新腕带设计，升级计步算法 / 精准心率监测，科学运动自主掌握', 1, 0);
INSERT INTO `commodity` VALUES ('xiaomi_005', 'headphones', '配件', 499, '2016-12', 'xiaomi/headphones.jpg', '小米头戴式耳机 升级版 石墨烯发声振膜 / 被动低频辐射器设计 / 封闭式音腔设计 / 手机直推高保真音质', 2, 0);
...
BEGIN
		...
		WHERE `comment`.commodityid = commodityid;
END
;;
delimiter ;
